...
const teamPlayerS = new Schema({ user: { type: Schema.Types.ObjectId, ref: "User", required: true }, role: { type: String, enum: PLAYER_ROLES }, battingPosition: Number, isGuest: { type: Boolean, default: false }, guestName: String, isTwoSider: { type: Boolean, default: false } }, { _id: false });
